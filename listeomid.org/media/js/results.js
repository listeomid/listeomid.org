...
function loadList(province, part, fileName){
	...
	if(province!=-1){
		...
		if (fileName=="kh-list"){
			title = 'میزان توفیق جریان‌های سیاسی در حوزه انتخابیه «'+province+'» در انتخابات  خبرگان'
		}else{
			title = 'میزان توفیق جریان‌های سیاسی در حوزه انتخابیه «'+part+'» در انتخابات مجلس دهم'
		}
		...
		if (fileName=="kh-list"){
			title = 'میزان توفیق جریان‌های سیاسی در کل کشور در انتخابات خبرگان'
		}else{
			title = 'میزان توفیق جریان‌های سیاسی در کل کشور در انتخابات مجلس دهم'
		}
		$("#chartOneTitle").text(title);	
